...
def recommend():
    ...
    # Get modules already completed by this student
    cursor.execute("""
    ...
    cursor.execute("""
        ...
        WHERE r.user_id = %s
          ...
          AND r.recommendation_type = 'VARK_NCF'
    ...
    for row in ncf_rows:
        ...
        # Do not recommend the current module
        if module_name == current_module:
            continue

        # Do not recommend modules already completed by the student
